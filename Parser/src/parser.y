...
class_definition
    ...
    ;
struct_declaration
    : STRUCT IDENTIFIER { pushScope(std::string($2)); } LBRACE member_list RBRACE SEMICOLON { addSymbol(std::string($2),"struct","struct"); free($2); popScope(); }
    ;
union_declaration
...
parameter_list
    ...
    | parameter_list COMMA DOT DOT DOT { $$=NULL; } /* Variable arguments */
    ;
parameter
